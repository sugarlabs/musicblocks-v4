...
function SelectWidget({
  ...
  widget: Extract<WidgetInput, { type: 'select' }>;
...
function NumberboxWidget({
  ...
  widget: Extract<WidgetInput, { type: 'numberbox' }>;
  commonStyle: React.CSSProperties;
  borderColor: string;
}) {
  return (
...
function ToggleWidget({
  ...
  widget: Extract<WidgetInput, { type: 'toggle' }>;
  commonStyle: React.CSSProperties;
  borderColor: string;
  backgroundColor: string;
}) {
...
function SliderWidget({
  ...
  widget: Extract<WidgetInput, { type: 'slider' }>;
  commonStyle: React.CSSProperties;
  borderColor: string;
}) {
  return (
