  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        'transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:ring-3',
        'aria-invalid:ring-3 data-checked:bg-(--widget-color,var(--color-primary))',
        'data-disabled:cursor-not-allowed data-disabled:opacity-50 data-[size=default]:h-[18.4px]',
