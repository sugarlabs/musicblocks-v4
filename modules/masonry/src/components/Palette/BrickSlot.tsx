    ...
    >
      <div className="overflow-hidden">
        <div
          ...
          className="palette-brick-slot flex min-h-11 cursor-grab touch-none items-center px-0 py-1 transition-colors select-none hover:brightness-110 active:cursor-grabbing"
        >
