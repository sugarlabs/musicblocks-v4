...
describe('Collision Utilities', () => {
    it('should detect overlapping rectangles', () => {
        const objA: TCollisionObject = { x: 5, y: 5, width: 10, height: 10 };
        const objB: TCollisionObject = { x: 10, y: 10, width: 10, height: 10 };
    ...
    it('should not detect collision for non-overlapping rectangles', () => {
        const objA: TCollisionObject = { x: 5, y: 5, width: 10, height: 10 };
        const objB: TCollisionObject = { x: 25, y: 25, width: 10, height: 10 };
    ...
    it('should detect overlapping circles', () => {
        const objA: TCollisionObject = { x: 5, y: 5, width: 10, height: 10 };
        const objB: TCollisionObject = { x: 12, y: 5, width: 10, height: 10 };
    ...
    it('should not detect collision for non-overlapping circles', () => {
        const objA: TCollisionObject = { x: 5, y: 5, width: 10, height: 10 };
        const objB: TCollisionObject = { x: 20, y: 5, width: 10, height: 10 };
