...
export function createMusicBlocksProgram(): ProgramDeclaration {
    ...
    const start1Block = new Block([new OnNoteDoStatement(new IdentifierExpression('action1'))]);
        ...
        new BranchStatement([
            {
                ...
                body: new Block([new RightStatement(new NumericLiteralExpression(90))]),
            },
            {
                test: new BooleanLiteralExpression(true),
                body: new Block([new LeftStatement(new NumericLiteralExpression(90))]),
            },
        ]),
    ]);
