...
import { BrickViewWithModel } from './Brick';

// Stories are fully render-driven (models cannot be serialised to Storybook
// args), so `component` is omitted from meta to avoid the TypeScript
// requirement for `args` on each story.
const meta: Meta = {
  title: 'Brick/Brick View (Model-based)',
  parameters: {
    layout: 'centered',
  },
};
